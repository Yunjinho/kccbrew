												...
												<form action="/as-assign" method="post" id="as-assign-form">
													<table id="search-box">
														...
														<tr>
															...
															<th>날짜 선택</th>
															<td><input type="date" name="visitDttm" id="visitDate"
																onchange="selectDate()" required></td>
															<th>수리 기사 목록</th>
															<td><select name="mechanicId" class="selectMcha" id="mechanicId"
																required>
											...
											<div>
												...
												<form action="/as-assign" method="post">
													...
													<input type="hidden" name="asInfoSeq"
														...
														value="${asDetailInfo.asResultSeq}">
												</form>
											</div>
										</c:if>
											...
											<c:if
												...
												<tr>
													...
													<td>
														<div>
															<a
																href="/as-mod?asInfoSeq=${asDetailInfo.asInfoSeq}&asAssignSeq=${asDetailInfo.asAssignSeq}"
																class="form-btn" style="margin: 0; float: right;">수정</a>
														</div>
													</td>
												</tr>
											</c:if>
